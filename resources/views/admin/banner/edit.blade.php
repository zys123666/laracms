...
@section('content')
    ...
    <div class="formbody">
        ...
        <form id="from" action="/banners/{{$banner->id}}" method="post" enctype="multipart/form-data">
            <div id="usual1" class="usual">
                <div class="itab">
                    <ul>
                        <li><a href="#tab1" class="selected">修改图片</a></li>
                    </ul>
                </div>
                <div id="tab1" class="tabson">
                    <ul class="forminfo">
                        ...
                        <li><label>banner描述<b>*</b></label><input name="banner_name" type="text" class="dfinput"
                                                              placeholder="请填写banner名称" value="{{$banner->banner_name}}" style="width:345px;"/></li>
                        <li><label>banner图片<b>*</b></label>
                            <input id="lefile" name="banner" type="file" style="display:none">
                            <div class="input-append">
                                <input id="photoCover" readonly class="input-large" type="text" name="banner_path" style="height:30px;width:265px;border:solid 1px #ccd0d2" value="{{$banner->path}}">
                                <a class="btn" onclick="$('input[id=lefile]').click();">选择图片</a>
                            </div>
                        </li>
                        <li><label>banner链接<b>*</b></label>

                            <input name="link" type="text" class="dfinput" placeholder="请填写banner跳转的地址" value="{{$banner->link}}" style="width:345px;"/>
